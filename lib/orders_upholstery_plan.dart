...
class OrdersUpholsteryPlanPage extends StatefulWidget {
  dynamic post = null;
  //dynamic filter;
  dynamic dropdownValue;
  OrdersUpholsteryPlanPage({Key key}) : super(key: key);
  @override
  _OrdersUpholsteryPlanPageState createState() => _OrdersUpholsteryPlanPageState();

}

class _OrdersUpholsteryPlanPageState extends State<OrdersUpholsteryPlanPage> {
  ...
  String columnDate = 'date_upholstery_plan';
  String columnFio = 'Z';
  ...
  Widget _appBarTitle = Text('План столярка');
