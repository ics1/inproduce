...
class OrdersCarpenterPlanPage extends StatefulWidget {
  dynamic post = null;
  //dynamic filter;
  dynamic dropdownValue;
  OrdersCarpenterPlanPage({Key key}) : super(key: key);
  @override
  _OrdersCarpenterPlanPageState createState() => _OrdersCarpenterPlanPageState();

}

class _OrdersCarpenterPlanPageState extends State<OrdersCarpenterPlanPage> {
  ...
  String columnDate = 'date_carpenter_plan';
  String columnFio = 'AZ';
