...
class OrdersSewingPlanPage extends StatefulWidget {
  dynamic post = null;
  //dynamic filter;
  dynamic dropdownValue;
  OrdersSewingPlanPage({Key key}) : super(key: key);
  @override
  _OrdersSewingPlanPageState createState() => _OrdersSewingPlanPageState();

}

class _OrdersSewingPlanPageState extends State<OrdersSewingPlanPage> {
  ...
  String columnDate = 'date_sewing_plan';
  String columnFio = 'BV';
  ...
  Widget _appBarTitle = Text('План швейка');
